...
export default class Key extends Component<KeyProps, KeyState> {
  ...
  componentDidMount() {
    addEventListener("mouseup", this.pageMouseUp, false);
  }
    ...
    return (
      <div
        className={"keyboard-key " +
          (note.bw === bw.white ? "white" : "black") +
          (this.state.clicked ? " clicked" : "") + (this.props.highlighted
